 ...
 core, sourceLibrary = [], dbStatus = 'local_only', onSave, onReset, onAddNewCoreSource, onLinkExistingSource }: Props) { 
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-24">
      {/* Header */}
      <div className="border-b border-border-standard pb-6 flex justify-between items-start">
        <div className="mb-6">
        ...
        <div className="flex flex-col items-end gap-3">
          <div className="flex items-center gap-3">
            <span className="text-xs font-semibold text-text-secondary">Core Status:</span>
            <button
          ...
          <div className="flex items-center gap-2 bg-violet-600/10 px-3 py-2 rounded border border-border-strong text-xs text-text-primary font-mono mt-2 mb-2 w-fit">
          ...
          {draftCore.lastUpdated && <span className="text-[10px] text-text-muted font-mono">Last updated: {new Date(draftCore.lastUpdated).toLocaleString()}</span>}
        </div>
      </div>
      ...
      <div className="flex gap-6">
        ...
        <div className="w-1/4 space-y-1">
          <div className="mb-4 p-3 bg-violet-600/5 rounded border border-border-standard text-xs">
            <h4 className="font-bold text-text-primary mb-2 border-b border-border-standard pb-1">Completeness</h4>
        ...
        <div className="w-3/4 bg-surface-primary p-6 rounded shadow-sm border border-border-standard h-[600px] overflow-y-auto">
          ...
          {activeTab === 'passport' && (
            <div className="space-y-6">
              <h3 className="font-sans text-xl font-bold text-text-primary border-b border-border-standard pb-2">Core Passport</h3>
              <p className="text-xs text-text-secondary mb-4">The quick identity layer of the system. Tells the Operating Core who we are before applying deeper rules.</p>
              
              {draftCore.corePassport.organizationName.toLowerCase() !== 'climate opera haus' && (
                <div className="bg-status-error/10 border border-status-error/20 text-status-error text-sm p-4 rounded mb-6 flex items-start gap-3">
          ...
          {activeTab === 'kernel' && (
            <div className="space-y-6">
              <h3 className="font-sans text-xl font-bold text-text-primary border-b border-border-standard pb-2">Strategy Kernel</h3>
              <p className="text-xs text-text-secondary mb-4">The deepest strategic logic inside the Operating Core.</p>
              ...
              <div>
                <div className="flex justify-between items-center mb-2 mt-4">
                  <label className="block text-xs font-bold text-text-primary">Internal Law / Non-Negotiables</label>
                  ...
                  }} className="text-xs text-brand-gold hover:text-brand-gold/80 flex items-center gap-1"><Plus size={12}/> Add Law</button>
                </div>
                  ...
                  {draftCore.strategyKernel.internalLaw.map((law, idx) => (
                    <div key={law.id} className="border border-border-standard p-3 rounded bg-surface-inset">
                      <div className="flex justify-between gap-2 mb-2">
                        ...
                        }} className="font-bold text-sm bg-transparent border-b border-border-strong w-1/3" placeholder="Rule Title"/>
          ...
          {activeTab === 'audiences' && (
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b border-border-standard pb-2 mb-4">
                <h3 className="font-sans text-xl font-bold text-text-primary">Audience Logic</h3>
                <button onClick={async () => {
                  setDraftCore(prev => ({
                ...
                }} className="text-xs text-brand-gold hover:text-brand-gold/80 flex items-center gap-1"><Plus size={12}/> Add Audience</button>
              </div>
              <div className="space-y-6">
          ...
          {activeTab === 'channels' && (
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b border-border-standard pb-2 mb-4">
                <h3 className="font-sans text-xl font-bold text-text-primary">Channel Rules</h3>
                <button onClick={async () => {
                  setDraftCore(prev => ({
                ...
                }} className="text-xs text-brand-gold hover:text-brand-gold/80 flex items-center gap-1"><Plus size={12}/> Add Channel</button>
              </div>
              <div className="space-y-6">
          ...
          {activeTab === 'claims' && (
            <div className="space-y-4">
              <h3 className="font-sans text-xl font-bold text-text-primary border-b border-border-standard pb-2">Claims &amp; Proof Boundaries</h3>
              ...
              <div className="flex justify-between items-center mb-2 mt-4 border-b border-border-standard pb-2">
                <label className="block text-sm font-bold text-text-primary">Specific Claim Boundaries</label>
                <button onClick={async () => {
                  setDraftCore(prev => ({
                ...
                }} className="text-xs text-brand-gold hover:text-brand-gold/80 flex items-center gap-1"><Plus size={12}/> Add Claim</button>
              </div>
              <div className="space-y-2">
                {draftCore.claimsProofBoundaries.claims.map((claim, idx) => (
                  <div key={claim.id} className="border border-border-standard p-2 rounded flex gap-2 items-start bg-surface-primary">
                    ...
                    }} className="text-xs border border-border-strong rounded p-1.5 w-32 shrink-0">
                    ...
                    <input value={claim.text} onChange={e => {
                      ...
                      setDraftCore(p => ({...p, claimsProofBoundaries: {...p.claimsProofBoundaries, claims: newC}}));
                    }} className="text-sm border border-border-strong rounded p-1 flex-1" placeholder="Claim text..."/>
                    {claim.type === 'Requires proof' && (
                      <input value={claim.proofRequirement} onChange={e => {
                        const newC = [...draftCore.claimsProofBoundaries.claims];
                        newC[idx].proofRequirement = e.target.value;
                        setDraftCore(p => ({...p, claimsProofBoundaries: {...p.claimsProofBoundaries, claims: newC}}));
                      }} className="text-xs border border-border-strong rounded p-1 w-40 shrink-0" placeholder="Required Proof..."/>
                    )}
                    <button onClick={async () => {
          ...
          {activeTab === 'revision' && (
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b border-border-standard pb-2 mb-4">
                <h3 className="font-sans text-xl font-bold text-text-primary">Revision Standards</h3>
                <button onClick={async () => {
                  setDraftCore(prev => ({
                ...
                }} className="text-xs text-brand-gold hover:text-brand-gold/80 flex items-center gap-1"><Plus size={12}/> Add Standard</button>
              </div>
              <div className="space-y-4">
          ...
          {activeTab === 'evidence' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center border-b border-border-standard pb-2 mb-4">
                <h3 className="font-sans text-xl font-bold text-text-primary">Core Documents</h3>
{dbStatus === 'local_only' ? (
              <div className="bg-status-error/10 border border-status-error/20 text-status-error text-xs p-3 rounded mb-4 flex items-center gap-2">
    ...
    setOperatingCoreDocuments(operatingCoreDocuments.filter(d => d.id !== doc.id));
                      ...
                      <div className="p-4 grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Document Type</label>
    ...
    setOperatingCoreDocuments(docs);
                        ...
                        <div>
                          <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Status</label>
    ...
    setOperatingCoreDocuments(docs);
                        ...
                        <div>
                          <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Brain Area</label>
    ...
    setOperatingCoreDocuments(docs);
                        ...
                        <div>
                          <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Brain Role</label>
    ...
    setOperatingCoreDocuments(docs);
                        ...
                        <div className="col-span-2">
                          <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Notes / Relevance</label>
    ...
    setOperatingCoreDocuments(docs);
                        ...
                        <div className="col-span-2">
                          <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Document Content</label>
    ...
    setOperatingCoreDocuments(docs);
                          ...
                          }} className="w-full bg-surface-primary border border-border-standard p-2 rounded text-xs text-text-primary h-16 mb-2" placeholder="The system distills rules from the content here..."/>
                          
                          <div className="grid grid-cols-2 gap-2 mb-2">
                            <div>
                              <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Distilled Notes (Strategy)</label>
    ...
    setOperatingCoreDocuments(docs);
                              ...
                              }} className="w-full bg-surface-primary border border-border-standard p-2 rounded text-xs text-text-primary h-12"/>
                            </div>
                            <div>
                              <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Extracted Claim Evidence</label>
    ...
    setOperatingCoreDocuments(docs);
                            ...
                            <div>
                              <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Voice Guidance</label>
    ...
    setOperatingCoreDocuments(docs);
                            ...
                            <div>
                              <label className="block text-[10px] uppercase font-bold text-text-secondary mb-1">Visual Guidance</label>
      ...
      <div className="mt-8 border border-border-standard bg-surface-primary rounded p-4">
        ...
        {showPreview && (
          <div className="mt-4 pt-4 border-t border-border-standard">
            <p className="text-xs text-text-secondary mb-4">Select a mock workspace context to preview exactly what rules are compiled and injected into the AI prompt.</p>
            <div className="flex gap-4 mb-4">
              <select value={previewCtx.workspace} onChange={e => setPreviewCtx({...previewCtx, workspace: e.target.value as any})} className="text-xs p-2 border rounded border-border-strong">
              ...
              <select value={previewCtx.audience} onChange={e => setPreviewCtx({...previewCtx, audience: e.target.value})} className="text-xs p-2 border rounded border-border-strong">
                <option value="">No Audience</option>
                {draftCore.audiences.map(a => <option key={a.id} value={a.name}>{a.name}</option>)}
              </select>
              <select value={previewCtx.channel} onChange={e => setPreviewCtx({...previewCtx, channel: e.target.value})} className="text-xs p-2 border rounded border-border-strong">
                <option value="">No Channel</option>
                {draftCore.channels.map(c => <option key={c.id} value={c.name}>{c.name}</option>)}
              </select>
              {previewCtx.workspace === 'Revision Studio' && (
                <select value={previewCtx.action} onChange={e => setPreviewCtx({...previewCtx, action: e.target.value})} className="text-xs p-2 border rounded border-border-strong">

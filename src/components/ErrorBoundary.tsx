...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="p-6 bg-red-500/10 backdrop-blur-md border border-red-200 rounded-3xl shadow-sm w-full h-full min-h-[300px] flex flex-col justify-center items-center text-center">
          <div className="text-red-600 mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
          </div>
          <h3 className="font-sans text-xl text-red-900 mb-2">{this.props.fallbackTitle || 'Something went wrong in this workspace.'}</h3>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 bg-red-700 text-text-primary rounded text-sm font-semibold hover:bg-red-800 transition"
            >
              Reload Workspace
            </button>
            <button

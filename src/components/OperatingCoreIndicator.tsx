...
export default function OperatingCoreIndicator({ core, workspaceName }: Props) {
  ...
  return (
    <div className="inline-flex items-center gap-1.5 mb-2">
      <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-900 text-white border border-border-standard rounded-full text-[10px] font-semibold cursor-default group relative">
        <span className="text-brand-gold">🛡️</span>
        <span>Protected COH Foundation</span>
        
        {/* Tooltip */}
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-slate-900 text-white rounded shadow-lg text-[9px] font-normal font-sans opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 pointer-events-none text-center">
